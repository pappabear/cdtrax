...
export function addCallCode(code, description) {
	return (dispatch) => {
		...
		request
            .post('https://cdtrax-backend-api.herokuapp.com/call_codes')
...
export function deleteCallCode(id) {
	return (dispatch) => {
        ...
        request
            .delete('https://cdtrax-backend-api.herokuapp.com/call_codes/' + id)
            .end((err, res) => {
                if (err) {
                    //console.log('addCallCode() API call failed')
                    dispatch(callCodesHasErrored(true))
...
export function updateCallCode(id, code, description) {
	return (dispatch) => {
        ...
        request
            .put('https://cdtrax-backend-api.herokuapp.com/call_codes/' + id)
...
export function getCallCodes() {
	return (dispatch) => {
		...
		request
            .get('https://cdtrax-backend-api.herokuapp.com/call_codes')
            .end((err, res) => {
                if (err) {
                    dispatch(callCodesHasErrored(true));
                }
...
export function getCallCode(id) {
	return (dispatch) => {
		...
		request
            .get('https://cdtrax-backend-api.herokuapp.com/call_codes/' + id)
            .end((err, res) => {
                if (err) {
                    dispatch(callCodesHasErrored(true));
                }
