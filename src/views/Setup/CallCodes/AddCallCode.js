...
import { addCallCode } from '../../../actions/callCodes'
...
class AddCallCode extends Component 
{
    ...
    handleAddCallCode() 
    {
        ...
        this.props.addCallCode(this.state.code, this.state.description)
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col xs={12} >
                        <form >
                        <Card>
                            <CardHeader><CardTitle> <b> Adding new CallCode </b> </CardTitle></CardHeader>
                                <CardBody>
                                    ...
                                    <Button outline color="success" onClick={() => this.handleAddCallCode()}>Save changes</Button> &nbsp;
...
const mapDispatchToProps = (dispatch) => {
    return {
        addCallCode: (code, description) => dispatch(addCallCode(code, description))
    }
}
