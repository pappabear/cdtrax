...
import { addCollateralCode } from '../../../actions/collateralCodes'
...
class AddCollateralCode extends Component 
{
    ...
    handleAddCollateralCode() 
    {
        ...
        this.props.addCollateralCode(this.state.code, this.state.description)
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col xs={12} >
                        <form >
                        <Card>
                            <CardHeader><CardTitle> <b> Adding new CollateralCode </b> </CardTitle></CardHeader>
                                <CardBody>
                                    ...
                                    <Button outline color="success" onClick={() => this.handleAddCollateralCode()}>Save changes</Button> &nbsp;
...
const mapDispatchToProps = (dispatch) => {
    return {
        addCollateralCode: (code, description) => dispatch(addCollateralCode(code, description))
    }
}
