...
import { addDisasterType } from '../../../actions/disasterTypes'
...
class AddDisasterType extends Component 
{
    ...
    handleAddDisasterType() 
    {
        ...
        this.props.addDisasterType(this.state.code, this.state.description)
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col xs={12} >
                        <form >
                        <Card>
                            <CardHeader><CardTitle> <b> Adding new Disaster Type </b> </CardTitle></CardHeader>
                                <CardBody>
                                    ...
                                    <Button outline color="success" onClick={() => this.handleAddDisasterType()}>Save changes</Button> &nbsp;
...
const mapDispatchToProps = (dispatch) => {
    return {
        addDisasterType: (code, description) => dispatch(addDisasterType(code, description))
    }
}
