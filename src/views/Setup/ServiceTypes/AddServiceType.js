...
import { addServiceType } from '../../../actions/serviceTypes'
...
class AddServiceType extends Component 
{
    ...
    handleAddServiceType() 
    {
        ...
        this.props.addServiceType(this.state.code, this.state.description)
            ...
            <div className="animated fadeIn">
                ...
                <Row>
                    <Col xs={12} >
                        <form >
                        <Card>
                            <CardHeader><CardTitle> <b> Adding new Service Type </b> </CardTitle></CardHeader>
                                <CardBody>
                                    ...
                                    <Button outline color="success" onClick={() => this.handleAddServiceType()}>Save changes</Button> &nbsp;
...
const mapDispatchToProps = (dispatch) => {
    return {
        addServiceType: (code, description) => dispatch(addServiceType(code, description))
    }
}
